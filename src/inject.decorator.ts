...
import { Injection, INJECTIONS, DependencyId, DependencyClass, ResolveScope } from './types';

/**
 * Registers an injection for dependency injection.
 *
 * @param dependencyId - Optional dependency identifier. If omitted, the property name is used.
 * @param scope - Optional scope to control where to search for dependency. Defaults to Current | Parent.
